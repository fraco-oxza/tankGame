...
class Terrain(Drawable, Collidable):
    ...
    def draw(self, screen: pygame.surface.Surface) -> None:
        ...
        pygame.draw.polygon(
            screen, constants.TERRAIN_COLOR, [[159, 89], [23, 485], [260, 485]]
        )
        pygame.draw.line(
            screen,
            constants.TERRAIN_COLOR,
        ...
        pygame.draw.polygon(
            screen, constants.TERRAIN_COLOR, [[542, 114], [328, 485], [783, 485]]
        )
        pygame.draw.line(
            screen,
            constants.TERRAIN_COLOR,
        ...
        pygame.draw.polygon(
            screen, constants.TERRAIN_COLOR, [[1280, 145], [861, 485], [1280, 486]]
        )
        pygame.draw.line(
            screen,
            constants.TERRAIN_COLOR,
